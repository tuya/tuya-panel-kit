...
const AcrylicEnumSliderCard: React.FC<IEnumSliderCardProps> = props => {
  const {
    data,
    sliderDotSize,
    sliderDotColor,
...
AcrylicEnumSliderCard.defaultProps = defaultProps;

export { IEnumSliderCardProps, AcrylicEnumSliderCard };
