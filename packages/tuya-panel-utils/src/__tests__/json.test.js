  ...
  it('JsonUtils.parseJSON()', () => {
    ...
    expect(result).toEqual({
      ...
      jest: {
        ...
        collectCoverageFrom: ['components/**/*.js', '!src/index.js', '!src/helpers/*.js'],
        collectCoverage: true,
        globals: { __DEV__: true },
      },
      author: ['fri3nds<chenglong@tuya.com>', 'cris<wanghuan@tuya.com>'],
      license: 'ISC',
    });
  });
  it('JsonUtils.parseJSON()', () => {
