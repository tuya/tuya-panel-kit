...
var INTERNAL_EVENT_TYPE = ["error", "newListener", "removeListener", "dpDataChange", "deviceChanged", "bluetoothChange", "deviceStateChange", "networkStateChange", "linkageTimeUpdate", "deviceLocalStateChange"],
  ...
  r && s && (Native = _extends({}, r, s), TYDeviceData.devInfo = {}, Device.formatDps = function (e) {
    ...
    return !!(r && r.mobileInfo && r.mobileInfo.appRnVersion) && r.mobileInfo.appRnVersion >= e;
  }, App.getNetworkState = function () {
    return new Promise(function (e) {
      r.getNetworkType(function (t) {
        e(t);
      });
    });
  }, App.is24Hour = function () {
    return new Promise(function (e) {
      r.is24Hour(function (t) {
        return e(t);
      });
    });
  }, App.getMobileInfo = function () {
    return new Promise(function (e, t) {
      TYMobileData ? t() : r.getMobileInfo(function (t) {
        return e(t);
      });
    }).then(function (e) {
