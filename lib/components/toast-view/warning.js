...
var _jsxFileName = 'src/components/toast-view/warning.js';
  ...
  _createClass(Warning, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          color = _props.color,
          props = _objectWithoutProperties(_props, ['text', 'contentStyle', 'showPosition', 'd', 'size', 'iconfontStyle', 'color']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_svg2.default, _extends({}, iconProps, { d: d, size: size, color: color, style: iconfontStyle, __source: {
            fileName: _jsxFileName,
            lineNumber: 75
          }
        }))
