...
var H5WebView = function (_Component) {
  ...
  function H5WebView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = H5WebView.__proto__ || Object.getPrototypeOf(H5WebView)).call.apply(_ref, [this].concat(args))), _this), _this.setInstance = function (ref) {
