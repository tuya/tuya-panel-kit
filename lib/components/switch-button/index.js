...
var ThemedSwitchButton = function ThemedSwitchButton(props) {
  ...
  return _react2.default.createElement(
    ...
    function (globalTheme) {
      ...
      var themedProps = {
        size: {
          width: isGradient ? getTheme(propsWithTheme, 'switchButton.width') + 7 : getTheme(propsWithTheme, 'switchButton.width'),
          height: ios ? getTheme(propsWithTheme, 'switchButton.height') : getTheme(propsWithTheme, 'switchButton.height') + 4,
