...
var _jsxFileName = 'src/components/iconfont/svg/index.web.js';
      ...
      return _react2.default.createElement(
        _reactNative.View,
        {
          style: [styles.row, {
            width: width * count,
            height: height
          }, transform.length > 0 && { transform: transform }, style],
          __source: {
        ...
        paths.map(function (pathData, i) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(_svgs.Path, _extends({}, pathProps, { fill: fill, stroke: stroke, d: pathData, __source: {
                fileName: _jsxFileName,
                lineNumber: 146
              }
            }))
