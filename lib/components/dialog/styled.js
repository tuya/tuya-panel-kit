...
var StyledContent = exports.StyledContent = (0, _native2.default)(_reactNative.View)(_templateObject3, cx(36) + 'px ' + cx(32) + 'px');
...
var StyledInputContainer = exports.StyledInputContainer = (0, _native2.default)(_reactNative.View)(_templateObject10, prompt.padding);
...
})(_templateObject11, subTitleFontColor);
