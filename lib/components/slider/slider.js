    ...
    value: function render() {
      ...
      if (horizontal) {
        ...
        if (allMeasured) {
          ...
          thumbTransformStyle = { transform: [{ translateX: thumbTranslate }] };
          if (!onlyMaximumTrack) {
            minimumTrackStyle = {
        ...
        if (allMeasured) {
          ...
          thumbTransformStyle = { transform: [{ translateY: thumbTranslate }] };
          if (!onlyMaximumTrack) {
            minimumTrackStyle = {
              overflow: 'hidden',
              position: 'absolute',
...
Slider.Vertical = function (_props) {
  return _react2.default.createElement(Slider, _extends({}, _props, {
