...
var dialog = {
  ...
  basic: {
    ...
    subTitleFontSize: 15,
    subTitleFontColor: 'rgba(0, 0, 0, 0.5)',
    cancelFontSize: 17,
    cancelFontColor: 'rgba(0, 0, 0, 0.7)',
    confirmFontSize: 17,
    confirmFontColor: 'rgba(0, 0, 0, 0.9)',
    prompt: {
      padding: '12px 0px',
  ...
  dark: {
    ...
    titleFontColor: '#FFF',
    subTitleFontSize: 15,
    subTitleFontColor: 'rgba(255, 255, 255, 0.7)',
    cancelFontSize: 17,
    cancelFontColor: 'rgba(255, 255, 255, 0.7)',
    confirmFontSize: 17,
