  ...
  function Stepper(props) {
    ...
    _this.renderEllipse = function () {
      var _this$props4 = _this.props,
          ...
          textInputProps = _objectWithoutProperties(_this$props4, ['min', 'max', 'style', 'buttonStyle', 'ellipseIconColor', 'selectionColor', 'inputStyle', 'editable']);
    ...
    _this.renderTriangle = function () {
      var _this$props5 = _this.props,
          ...
          textInputProps = _objectWithoutProperties(_this$props5, ['min', 'max', 'style', 'buttonStyle', 'triangleIconColor', 'selectionColor', 'iconMinusPath', 'iconPlusPath', 'inputStyle', 'editable']);
