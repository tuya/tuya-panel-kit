...
var PortalOut = function (_React$Component) {
  ...
  _createClass(PortalOut, [{
    ...
    value: function render() {
      ...
      var props = this.node['' + lastUuid].props;
      ...
      var activeIdx = 0;
      var nodes = uuidList.map(function (key, idx) {
        activeIdx = idx;
      ...
      return _react2.default.createElement(
        _TYModal2.default,
        _extends({ activeIdx: activeIdx }, needProps, {
          __source: {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.remove = function (uuid) {
    if (!_this3.node['' + uuid]) return;
    var hasRegistered = _this3.state.uuidList.find(function (id) {
      return id === uuid;
    }) > -1;
    if (hasRegistered) {
