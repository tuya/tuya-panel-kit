...
var ProgressSimple = function (_Gesture) {
  ...
  _createClass(ProgressSimple, [{
    ...
    value: function fixDegreeAndBindToInstance(props) {
      ...
      var deltaDeg1 = this.mapValueToDeltaDeg(value1, true);

      this.foreScalePath1 = this.createSvgPath(deltaDeg1);

      var deltaDeg2 = this.mapValueToDeltaDeg(value2, false);
    ...
    value: function mapValueToDeltaDeg(value, bool) {
    ...
    value: function render() {
      ...
      var _props6 = this.props,
          ...
          style = _props6.style,
          scaleHeight1 = _props6.scaleHeight1,
          scaleHeight2 = _props6.scaleHeight2,
          thumbFill = _props6.thumbFill,
          thumbStrokeWidth = _props6.thumbStrokeWidth,
          thumbStroke = _props6.thumbStroke,
          thumbRadius1 = _props6.thumbRadius1,
          thumbRadius2 = _props6.thumbRadius2,
          needCircle1 = _props6.needCircle1,
          startColor = _props6.startColor,
          needCircle2 = _props6.needCircle2,
          endColor = _props6.endColor;
