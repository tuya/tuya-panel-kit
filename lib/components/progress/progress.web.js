...
var _jsxFileName = 'src/components/progress/progress.web.js';
  ...
  _createClass(Progress, [{
    ...
    value: function mapDeltaDegToValue(deltaDeg) {
      ...
      if (stepValue) {
        ...
        var _value2 = Math.round(_deltaValue / this.andDegree);
    ...
    value: function render() {
      ...
      var minCircleColor = value === min ? backColor : isGradient ? Object.values(foreColor)[0] : foreColor;
      var maxCircleColor = value === max ? isGradient ? Object.values(foreColor)[Object.values(foreColor).length - 1] : foreColor : backColor;
