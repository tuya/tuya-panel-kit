...
var ProgressDouble = function (_Gesture) {
  ...
  _createClass(ProgressDouble, [{
    ...
    value: function fixDegreeAndBindToInstance(props) {
      ...
      var deltaDeg = this.mapValueToDeltaDeg(maxValue);
      var minDeltaDeg = this.mapValueToDeltaDeg(minValue);
    ...
    value: function eventHandle(_ref2, fn) {
      ...
      if (this.shouldUpdateScale(locationX, locationY)) {
        ...
        var locationToEnd = Math.sqrt(Math.pow(this.progressX - locationX, 2) + Math.pow(this.progressY - locationY, 2));
        var locationToStart = Math.sqrt(Math.pow(this.progressStartX - locationX, 2) + Math.pow(this.progressStartY - locationY, 2));
    ...
    value: function render() {
      ...
      var _props4 = this.props,
          ...
          minThumbFill = _props4.minThumbFill,
          minThumbStroke = _props4.minThumbStroke,
