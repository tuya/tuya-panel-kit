...
var TOPBAR_ACTION_TEXT_WIDTH = exports.TOPBAR_ACTION_TEXT_WIDTH = 70;

var StyledTopBarContainer = exports.StyledTopBarContainer = (0, _native2.default)(_reactNative.View)(_templateObject, TOPBAR_HEIGHT, function (props) {
  return getTheme(props, 'topbar.background', DEFAULT_THEME.background);
});
