  ...
  _createClass(NewOfflineView, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          isJumpToWifi = _props.isJumpToWifi;
      ...
      var imgUrl = _reactNative.Platform.OS === 'ios' ? get(_TYNativeApi.TYSdk, 'devInfo.iconUrl') : get(_TYNativeApi.TYSdk, 'devInfo.icon');
      var topBarMoreIconName = get(_TYNativeApi.TYSdk, 'devInfo.panelConfig.fun.topBarMoreIconName', 'pen');
      return _react2.default.createElement(
                ...
                !!textLink && _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      _reactNative.Text,
                      {
                        style: [styles.firstLine, isJumpToWifi && {
                          color: '#FF4800',
        ...
        _react2.default.createElement(
          _reactNative.TouchableOpacity,
          {
            ...
            activeOpacity: 0.8,
            onPress: function onPress() {
              return TYNative.showDeviceMenu();
            },
            __source: {
              fileName: _jsxFileName,
              lineNumber: 206
