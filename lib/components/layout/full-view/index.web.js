...
var _jsxFileName = 'src/components/layout/full-view/index.web.js';
...
var FullView = function (_Component) {
  ...
  _createClass(FullView, [{
    ...
    value: function renderBackground(background) {
      ...
      if (typeof background === 'object') {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_svgs.Rect, { x: '0', y: '0', height: Screen.height, width: Screen.width, __source: {
              fileName: _jsxFileName,
              lineNumber: 187
            }
          })
    ...
    value: function renderOfflineView() {
      ...
      var tipText = !appOnline ? _TYNativeApi.Strings.getLang('appoffline') : !deviceOnline ? _TYNativeApi.Strings.getLang('offline') : '';
    ...
    value: function renderTopBar() {
      ...
      if (!hideTopbar) {
        ...
        var uiPhase = _TYNativeApi.TYSdk.devInfo.uiPhase || 'release';
    ...
    get: function get() {
      return _TYNativeApi.TYSdk.devInfo.panelConfig && _TYNativeApi.TYSdk.devInfo.panelConfig.fun && _TYNativeApi.TYSdk.devInfo.panelConfig.fun.topBarMoreIconName || 'pen';
    }
  }]);
