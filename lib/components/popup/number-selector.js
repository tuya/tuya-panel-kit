    ...
    _this._handlePressIn = function (isAdd) {
      return function () {
        var _this$props4 = _this.props,
            valueChangeTime = _this$props4.valueChangeTime,
            isValueChangeUniform = _this$props4.isValueChangeUniform;
        ...
        _this._interval = setInterval(function () {
          ...
          if (!_this._pressInTime) {
            ...
            _this._stepLevel = isValueChangeUniform ? 1 : level;
          }
          runner();
        }, valueChangeTime);
      };
...
NumberSelectorPopup.propTypes = {
  ...
  valueChangeTime: _propTypes2.default.number,

  isValueChangeUniform: _propTypes2.default.bool
};
