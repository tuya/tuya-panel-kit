...
var I18N = function () {
  function I18N(props) {
    ...
    if (typeof TYNative.mobileInfo === 'undefined') {
      TYMobile.getMobileInfo().then(function (d) {
  ...
  _createClass(I18N, [{
    key: 'applyStrings',
    value: function applyStrings(strings) {
      var strLang = this.mergeLanguage(strings, TYNative.lang);
    ...
    value: function forceUpdateNetworkLang(productId) {
      ...
      return new Promise(function (resolve, reject) {
        _TYNativeApi2.default.apiRequest({
          a: 'tuya.m.i18n.get',
          postData: {
            productId: productId,
            moduleName: 'h5',
          ...
          if (data) {
            _this2.strings = _this2.mergeLanguage(_this2.strings, data);
            _this2.buildLanguage(_this2.language);
            resolve(data);
          } else {
            reject();
          }
    ...
    value: function setLanguage(language) {
      var bestLanguage = this._getBestMatchingLanguage(language, this.strings);
